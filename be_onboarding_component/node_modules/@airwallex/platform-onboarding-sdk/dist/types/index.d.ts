 ...
 * Create element
 */
export declare function createElement(elementType: ElementType, options: ElementOptionsTypeMap[ElementType]): Element | null;
/**
 * Define of error code
 */
export type ERROR_CODE = 'NO_AUTH_CODE' | 'UNAUTHORIZED' | 'SUBMIT_FAILED' | 'CREATE_ELEMENT_ERROR' | 'MOUNT_ELEMENT_ERROR' | 'UNKNOWN';
/**
